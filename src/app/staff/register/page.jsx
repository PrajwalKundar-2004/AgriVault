          ...
          <form onSubmit={handleRegister} className="space-y-3">
            ...
            <motion.div variants={itemVariants}>
              ...
              <input 
                ...
                onChange={handleInputChange}
                className="w-full px-4 py-3.5 text-sm rounded-xl border border-slate-700/50 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all bg-slate-800/50 text-white placeholder-slate-500 shadow-inner"
                placeholder="••••••••"
              />
            </motion.div>
